...
import inweb.spring.clab_criptomonedas_servidor_https_spring.controlador.Pagina_inicio;
...
public class Clab_criptomonedas_servidor_https_spring extends Servidor_https_spring {

    public static void main(String[] args) {
        oks ok = new oks();
        try {
            Clab_criptomonedas_servidor_https_spring servidor_https_spring 
                    = new Clab_criptomonedas_servidor_https_spring();
            servidor_https_spring.run(ok, Clab_criptomonedas_servidor_https_spring.class, args);
        } catch (Exception e) {
            ok.setTxt(e);
        }
        if (ok.es == false) {
